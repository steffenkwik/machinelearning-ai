...
export const ETHICS = [
  ...
  { title: "Validasi Data Nyata", body: "Pendekatan inti divalidasi pada dataset stunting balita nyata Indonesia (55.367 sampel, berbasis WHO) dengan akurasi 99,4% — bukti model bekerja pada kondisi data riil, bukan hanya simulasi." },
];
