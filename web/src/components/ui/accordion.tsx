...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-3 p-5 text-left text-sm font-bold text-emerald-900 transition-all hover:bg-emerald-50/50 [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
